...
<link rel="pingback" href="<?php bloginfo( 'pingback_url' ); ?>">
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/library/css/layouts.css">
...
<!-- Preloader -->
<div id="preloader" class="no-show">
...
// Home page animation
	...
	<div class="header">
        ...
        <div id="morphsearch" class="morphsearch">
            <form class="morphsearch-form" method="get" action="<?php bloginfo('home'); ?>">
                <input class="morphsearch-input" type="search" placeholder="What are you looking for?" value="<?php echo get_search_query() ?>" name="s" />
		...
		<div class="site-width">
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>/#anchor"><?php get_template_part('svg/inline', 'rea-logo-header.svg'); ?></a>
			<?php $custom_menu = array( 
				'theme_location' => 'primary', 
				'menu_id' => 'primary-menu',
				'container' => '',
